...
<table style="display: inline-block;">
	...
	<tr>
		<th><div><img width="100px" style="float: left;" src="${pageContext.request.contextPath }/upload/${li.savefilename }"></div><br>KILA | ${li.pcode }<br>${li.pname }<br>${li.color }/${li.psize }</th>
		<th>${li.cnt }</th><th>${li.price }</th><th>0원</th><th>0원</th><th>${li.price * li.cnt }</th>
	</tr>
	</c:forEach>
	<tr>
		<th height="100" colspan="7" style="background-color: pink;">상품합계 : ${tot } + 배송비 : <span style="color: red;">0</span>
		<c:forEach begin="1" end="80">&nbsp</c:forEach>
		<h1 style="display: inline-block;">총 결제금액: <span style="color: red;">${tot }</span></h1></th>
	</tr>
</table>
	<br>
	<h2>주문자 정보</h2>
